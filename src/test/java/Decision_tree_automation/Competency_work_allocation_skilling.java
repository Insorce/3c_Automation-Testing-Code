...
public class Competency_work_allocation_skilling 
{
...
//		saveandcontinue2.click();
//
//		//click here to enter the bench mark cost per annum
//		Thread.sleep(1000);
//		WebElement benchmarkcost=driver.findElement(By.xpath("//tbody/tr[1]/td[5]/span[1]/a[1]"));
//		benchmarkcost.click();
//
//		//enter the low cost
//		Thread.sleep(2000);
//		WebElement lowcost=driver.findElement(By.xpath("//input[@id='LowCost']"));
//		lowcost.sendKeys(Keys.CONTROL, Keys.chord("a"));
//		lowcost.sendKeys(Keys.BACK_SPACE);
//		lowcost.sendKeys("200");
//		//enter the medium cost
//		Thread.sleep(2000);
//		WebElement mediumcost=driver.findElement(By.xpath("//input[@id='MediumCost']"));
//		mediumcost.sendKeys(Keys.CONTROL.chord("a"));
//		mediumcost.sendKeys(Keys.BACK_SPACE);
//		mediumcost.sendKeys("500");
//
//		//enter the highest cost
//		Thread.sleep(2000);
//		WebElement highestcost=driver.findElement(By.xpath("//input[@id='HighCost']"));
//		highestcost.sendKeys(Keys.CONTROL.chord("a"));
//		highestcost.sendKeys(Keys.BACK_SPACE);
//		highestcost.sendKeys("500");
//	   
//		  
//		//click on save and proceed
//		WebElement save_and_proceed=driver.findElement(By.xpath("//div[@id='SetBenchmarkCostDialogue']/descendant::button[text()='Save & Proceed']"));
...
//		//click on save and continue
//		Thread.sleep(2000);
//		WebElement saveandcontinue23=driver.findElement(By.xpath("//button[@id='LocationSaveContinue']"));
