...
public class Control_coverage_control_effort_automation_robotics 
{

	@Test
	public static void automation_robotics() throws Exception
	{
		...
		WebDriverWait Automation_robotics=new WebDriverWait(driver, Duration.ofSeconds(60));
		WebElement Automation_robotic=Automation_robotics.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='dvLeversSection']/descendant::a[@href='/Operations/ControlsAutomation']")));
		JavascriptExecutor click_robotics = (JavascriptExecutor) driver;
		click_robotics.executeScript("arguments[0].click();", Automation_robotic);
