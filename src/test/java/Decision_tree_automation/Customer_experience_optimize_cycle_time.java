...
public class Customer_experience_optimize_cycle_time 
...

{
	...
	@Test
	public static void optimize_cycle() throws FileNotFoundException, InterruptedException
	{
		...
		WebElement serial_batch=serial.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[text()='Optimize Cycle Time']")));
