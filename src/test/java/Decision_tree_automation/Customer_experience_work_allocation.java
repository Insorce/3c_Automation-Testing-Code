...
public class Customer_experience_work_allocation 
{


	@Test
	public static void work_allocations() throws Exception
	{
		...
		//click on work allocation widget
		WebDriverWait work=new WebDriverWait(driver, Duration.ofSeconds(6000));
		WebElement click_work_allocation=work.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='dvLeversSection']/descendant::a[@href='/Operations/BottlenecksWorkAllocation']")));
		Actions action1=new Actions(driver);
		action1.click(click_work_allocation).perform();
		Thread.sleep(10000);
