...
public class Decision_tree_task 

{
	...
	public static void main() throws FileNotFoundException
	{
		...
		WebElement insorce678=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[text()='3277: widget_testing_automation']")));
		...
		String node= effort_node.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@id='205']"))).getText();
		...
		//compare the text in customer experience tree
