...
public class control_coverage_control_rework_rework_rejections
{

	@Test
	public static void control_rework_rejections() throws Exception
	{
		...
		wait11.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@id='305']"))).click();

		//click on tree node and get text
		WebDriverWait wait111=new WebDriverWait(driver, Duration.ofSeconds(20));
		String node= wait111.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@id='305']"))).getText();
		System.out.println(node);

		//here we need to compare the decision tree values
		String expectedValue ="Control Rework\n"+ "77.1%";
		...
		WebElement rework_and_reductions=rework.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='dvLeversSection']/descendant::a[@href='/Operations/ControlsRework']")));
