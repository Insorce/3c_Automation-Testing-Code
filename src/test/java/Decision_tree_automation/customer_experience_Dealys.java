...
public class customer_experience_Dealys 
{
	
	
	
	@Test
	public static void customer_experiecnce_delays() throws Exception
	{
...
//		
		...
		WebElement reductions=rework.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//h5[text()='Delays'])[1]")));
